...
var BOARD = {
    ...
    article_move : function(link, board_no, listName, aNo, return_url)
    {
        ...
        if (board_no == dest_board_no) {
            alert("동일한 게시판으로 게시물을 이동 할 수 없습니다.");
            return false;
        }
    ...
    {
        this.OpenWindow('/admin/php/b/board_admin_pre_comment_l.php?mode=popup', 'pre_comment', '1300', '650','auto');
    },
